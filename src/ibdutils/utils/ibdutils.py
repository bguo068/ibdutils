...
class IBD:
    ...
    def plot_coverage(
        ...
        for x in chr_boundaries:
            ax.axvline(x, lw=0.5, color="black")
        ...
        ax.set_xlim(chr_boundaries[0], chr_boundaries[-1])
    ...
    def plot_drg_annotation(self, ax, plot_drg_label=True):
        ...
        for t in labels:
            ...
            elif t.get_text() in ["PF3D7_1322700"]:
                t.set_transform(ax.get_xaxis_transform() + right_offset2)
            elif t.get_text() in ["gch1"]:
...
class IbdComparator:
    def __init__(self, trueibd: IBD, inferibd: IBD) -> None:
        ...
        self.gmap: GeneticMap = trueibd._genome._gmap
